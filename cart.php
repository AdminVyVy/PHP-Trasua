                        ...
                        <div class="panel panel-primary">
                            <div class="panel-heading" style="padding: 1rem 0;">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link" href="history.php">Purchase history</a>
                                    </li>
                                </ul>
                                <h2 style="padding-top:2rem" class="">Cart</h2>
                            </div>
                            <div class="panel-body"></div>
                            <table class="table table-bordered table-hover">
                                <thead>
                                    <tr style="font-weight: 500;text-align: center;">
                                        <td width="50px">Order number</td>
                                        <td>Picture</td>
                                        <td>Product Name</td>
                                        <td>Price</td>
                                        <td>Amount</td>
                            ...
                            <p>Total Order: <span class="red bold"><?= number_format($total, 0, ',', '.') ?><span> VNĐ</span></span></p>

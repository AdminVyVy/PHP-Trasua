...
<ul class="nav nav-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="../admin/dashboard.php">Manage shopping cart</a>
                    </li>
                    <li class="nav-item">
                                ...
                                foreach ($order_details_List as $item) {
                                    echo '
                                        <tr style="text-align: center;">
                                            ...
                                            <td width="100px">
                                                <a href="edit.php?action=edit&order_id=' . $item['order_id'] . '" class="btn btn-success">Edit</a>
                                            </td>
                                        </tr>
                                    ';
                                }

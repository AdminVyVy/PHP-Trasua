            ...
            <div class="container">
                <form action="" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password-new" class="form-control" placeholder="New Password">
                    </div>
                    <div class="form-group">
                        <label for="">Re-enter new password:</label>
                        <input type="password" name="repassword-new" class="form-control" placeholder="Re-enter new password">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p style="padding-top: 1rem;"><a href="reg.php">Forgot password?</a></p>
                    </div>
                </form>
            </div>
        </div>

        ...
        <div id="wrapper">
            ...
            <div class="container">
                <form method="POST" action="">
                    ...
                    <button name="send" class="btn btn-primary">Restore</button>
                    <?php
            ...
            if ($_SERVER['REQUEST_METHOD'] == "POST") {
                ...
                if ($numrows_email == 1) {
                    foreach ($kq as $item) {
                         $message = 'Hello ' . '<strong>' . $item['username'] . '</strong>' . '<br>Your password is: ' . '<strong>' . $item['password'] . '</strong>';
                    }
                } else {
                ...
                try {
                    ...
                    $nguoigui = 'pvy10113008@gmail.com'; // Tài khoản Email
                    $matkhau = 'pvy1011'; // Mật khẩu Email
                    $mail->SMTPSecure = 'ssl';  // encryption TLS/SSL 
                    $mail->Port = 465;  // Port kết nối: khai báo 465 hoặc 587                
                    // Recipients - Người nhận
                    $tennguoigui = 'Võ Lê Phương Vy'; // Tên người gửi lấy từ form nhập
                    $mail->Username = $nguoigui; // SMTP username
                    $mail->Password = $matkhau;   // SMTP password
                    $mail->setFrom($nguoigui, $tennguoigui); //mail và tên người nhận 
                    $to = $email; // Email cần gửi đến lấy từ form nhập
                    $to_name = "Võ Lê Phương "; // Tên người cần gửi đến
                    // Content 
